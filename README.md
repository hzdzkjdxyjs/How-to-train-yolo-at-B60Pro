# How-to-train-yolo-at-B60Pro
 ...
 - 这是一个教程，教您如何在B60Pro上运行yolo，目前分为三个部分
 - 主文件是本文件直接教你怎么训练模型
- [模型部署章节（格式转换）](https://github.com/hzdzkjdxyjs/How-to-train-yolo-at-B60Pro/blob/main/deploy.md)
- [val 章节（速度和精度对比）](https://github.com/hzdzkjdxyjs/How-to-train-yolo-at-B60Pro/blob/main/val.md)
- [量化章节（如何量化模型）](https://github.com/hzdzkjdxyjs/How-to-train-yolo-at-B60Pro/blob/main/quantize.md)
---
